let weightRecords = [];
        ...
        async function checkSession(token) {
            try {
                const response = await fetch("https://planime-rest-api.diecode.lat/api/protected/session", {
                    method: "GET",
                    headers: {
        ...
        async function getAllWeightRecords(token) {
            try {
                const response = await fetch("https://planime-rest-api.diecode.lat/api/protected/getAllWeightR", {
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${token}`
                    },
        ...
        async function getWeightGoal(token) {
            try {
                const response = await fetch("https://planime-rest-api.diecode.lat/api/protected/getWeightGoal", {
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
        ...
        async function saveWeightRecord() {
            try {
                ...
                const response = await fetch("https://planime-rest-api.diecode.lat/api/protected/setWeightRecord", {
                    method: "POST",
                    headers: {
        ...
        async function saveWeightGoal() {
            try {
                ...
                const response = await fetch("https://planime-rest-api.diecode.lat/api/protected/setWeightGoal", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${currentToken}`
...
async function executeDelete() {
    try {
        ...
        const response = await fetch(`https://planime-rest-api.diecode.lat/api/protected/deleteWeightR/${recordId}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${currentToken}`
